  ...
  return (
    <div className={isSheet ? "px-2 pb-2" : ""}>
      ...
      <a
        ...
        onClick={onClose}
        className={`flex w-full items-center gap-2.5 text-sm font-semibold text-slate-800 hover:bg-indigo-50 ${
          isSheet ? "rounded-xl px-4 py-3.5" : "px-3.5 py-2.5"
        }`}
      >
        ...
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-t-xl bg-slate-50">
          ...
          {item.image_url && !imgError ? (
            <img
              ...
              className="block h-full w-full cursor-zoom-in object-contain object-center"
